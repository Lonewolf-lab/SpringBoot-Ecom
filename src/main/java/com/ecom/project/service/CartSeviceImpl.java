...
import com.ecom.project.repositories.CartItemRepository;
...
public class CartSeviceImpl implements CartService{
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if (product.getQuantity() < quantity){
            throw new APIexception("Please, make an order of the " + product.getProductName() + "less than or equal to the quantity available");
        }
